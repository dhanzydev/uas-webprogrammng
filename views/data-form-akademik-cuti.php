                                ...
                                <tbody>
                                    <?php foreach ($formcuti->displayData() as $data) { ?>
                                        <tr>
                                            ...
                                            <form action="index.php?page=form-cuti-setuju&id=<?php echo $data['id'] ?>" method="post">
                                                <td>
                                                    ...
                                                    <a href="index.php?page=print-izin-cuti&id=<?php echo $data['id'] ?>" target="_blank" class="btn btn-primary">Print</a>
                                                </td>
                                            </form>
                                        </tr>
                                    <?php } ?>
